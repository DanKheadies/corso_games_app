...
class BallBounceBoard extends RectangleComponent
    with DragCallbacks, HasGameRef<BallBounceGame> {
  ...
  void _updateDragRelatedParameters(DragUpdateEvent event) {
    dragRelativePosition.setFrom(event.localStartPosition - dragStartPosition);

    final absolutePosition = (event.localStartPosition - dragStartPosition)
      ..absolute();
